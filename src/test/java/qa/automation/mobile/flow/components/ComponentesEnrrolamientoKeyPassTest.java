...
@SuiteClasses({ ViewLoginEnrolStageSet.class, EditRutLoginEnrolStageSet.class,
		EditClaveInternetLoginEnrolStageSet.class, ButtonIngresarLoginEnrolStageSet.class,
		ViewEsTuCelularEnrolStageSet.class, EditNumeroCelularEnrolStageSet.class, ButtonConfirmarTelEnrolStageSet.class,
		ViewIngresoSmsEnrolStageSet.class, ButtonReenviarSmsEnrolStageSet.class, EditCodigoSmsEnrolStageSet.class,
		ButtonIngresarCodigoSmsEnrolStageSet.class, ViewSeleccionClaveEnrolStageSet.class,
		ButtonCrearClaveMobileEnrolStageSet.class, EditCrearClaveMobileEnrolStageSet.class,
		EditRepiteClaveMobileEnrolStageSet.class, ButtonClaveWebEnrolStageSet.class,
		ButtonIngresarClaveEnrolStageSet.class, ViewClaveScotiapassEnrolStageSet.class,
		EditScotiapassEnrolStageSet.class, ButtonIngresarScotiapassEnrolStageSet.class })
public class ComponentesEnrrolamientoKeyPassTest extends BaseFlow {
	private static final Logger LOGGER = LoggerFactory.getLogger(ComponentesEnrrolamientoKeyPassTest.class);

	@BeforeClass
	public static void flag() throws Exception {
		LOGGER.info("Ejecutando validacion componentes en enrrolamiento clave mobile ...");
	}
}